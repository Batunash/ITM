...
const s = {
  ...
  featureDot: { width: 8, height: 8, borderRadius: '50%', background: '#94a3b8', marginTop: 6, flexShrink: 0 },
  ...
  forgotLink: { fontSize: 13, color: '#334155', textDecoration: 'none', fontWeight: 500 },
  submitBtn: { display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, background: '#334155', color: '#fff', border: 'none', padding: '12px', borderRadius: 4, fontSize: 15, fontWeight: 600, cursor: 'pointer', marginTop: 4, transition: 'background 0.15s' },
  ...
  demoBtn: { background: '#f8fafc', border: '1.5px solid #e2e8f0', borderRadius: 4, padding: '10px 12px', cursor: 'pointer', textAlign: 'left', transition: 'border-color 0.15s, background 0.15s' },
  demoRole: { display: 'block', fontSize: 12, fontWeight: 700, color: '#1e293b', marginBottom: 2 },
